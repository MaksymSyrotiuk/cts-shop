...
<body>
    ...
    <section class="info-block">
        <h1 class="info-block-h1">New Account</h1>
        <h2 class="description-for-block">Create an account to start</h2>
        <form action="../src/modules/register.php" method="post">
            <div class="form">
                <div class="block-for-text">
                    <p class="text-for-block">Login</p>
                    <p class="text-for-block">E-mail</p>
                    <p class="text-for-block">Password</p>
                    <p class="text-for-block">Gender</p>
                    <p class="text-for-block">Date of Birth</p>
                </div>
